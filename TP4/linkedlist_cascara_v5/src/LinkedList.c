...
static Node* getNode(LinkedList* this, int nodeIndex)
{
    ...
    if(this !=NULL && nodeIndex<lenList&&nodeIndex>=0)
    {
...
static int addNode(LinkedList* this, int nodeIndex,void* pElement)
{
    ...
    if(this!=NULL && nodeIndex>=0 && nodeIndex<=lenList && pNewNode!=NULL)
    {
        if(nodeIndex==0)
        {
...
void* ll_get(LinkedList* this, int index)
{
    ...
    int lenList=ll_len(this);
    Node* pNode;
    if(this!=NULL && index<=lenList && index>=0)
    {
...
int ll_set(LinkedList* this, int index,void* pElement)
{
    ...
    int lenList=ll_len(this);
    Node* pNode;
    if(this!=NULL && index>=0 && index<lenList)
    {
        pNode=getNode(this,index);
        if(pNode!=NULL)
        {
...
{
    int returnAux = -1;
    int lenList1=ll_len(this);
    int lenList2=ll_len(this2);
    int i;
    void* pElemento1;
    void* pElemento2;
    int contador=0;
    if(this!=NULL && this2!=NULL)
    {
        for(i=0;i<lenList1;i++)
        {
            ...
            pElemento2=ll_get(this2,i);
            if(pElemento1==pElemento2)
            {
                contador++;
            }
        }
        if(contador==lenList1 && lenList2==lenList1)
        {
            returnAux=1;
        }
        else
...
LinkedList* ll_subList(LinkedList* this,int from,int to)
{
    ...
    int lenList=ll_len(this);
    if(this!=NULL && from>=0 && from<lenList && to>=0 && to<lenList)
    {
